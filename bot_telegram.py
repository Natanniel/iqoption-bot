...
from src.menus.gerenciamento import entrarEmGerenciamento, alterarDelay,alterarStopWin,alterarStopLoss,alterarEmailIQ, alterarSenhaIQ,alterarModoReal
from src.menus.modooperacao import entrarEmModoOperacao, entrarEmModoMaoFixa, alterarMaoFixa
from src.menus.lista import entrarEmLista,limparLista,adicionarLista
from src.menus.operar import entrarEmOperar,entrarEmOperarMaoFixa,cancelarOperacao,confirmarOperacao, interromperOperacao
                                            ...
                                            if(update.message.text ==  '🔂 Margin-Gale'):
                                                ...
                                                if(update.message.text == '🤖 Operar'):
                                                 ...
                                                 #   update.message.reply_text("Falha ao se comunicar com a IQOption")
                                                    ...
                                                    if(update.message.text == '🤖🖐️ Mão Fixa'):
                                                        entrarEmOperarMaoFixa(update,context)
                                                    else:
                                                        if not re.match(r"[^@]+@[^@]+\.[^@]+", update.message.text):
